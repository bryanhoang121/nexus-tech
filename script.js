...
const translations = {
  en: {
    ...
    services: "Services",
    contact: "Contact",
    welcome: "Welcome to NexusTech Viet Nam",
    ...
    "service1-description": "Build innovative and scalable software, web, and mobile applications tailored to your business needs.",
    "service2-title": "Chatbot Development",
    "service2-description": "Enhance customer engagement with smart, AI-driven chatbots designed for seamless interactions and automation.",
    ...
    footer: "© 2024 Nexus Tech Viet Nam. All rights reserved.",
  ...
  vi: {
    ...
    services: "Dịch vụ",
    contact: "Liên hệ",
    welcome: "Chào mừng đến với NexusTech Việt Nam",
    ...
    "service1-description": "Xây dựng phần mềm, ứng dụng web và di động sáng tạo, có thể mở rộng phù hợp với nhu cầu của doanh nghiệp bạn.",
    "service2-title": "Phát triển Chatbot",
    "service2-description": "Tăng cường tương tác với khách hàng bằng các chatbot thông minh, được hỗ trợ bởi AI, thiết kế để tự động hóa và tối ưu hóa giao tiếp.",
    ...
    footer: "© 2024 Nexus Tech Việt Nam. Bản quyền thuộc về chúng tôi.",
    // Contact section translations
